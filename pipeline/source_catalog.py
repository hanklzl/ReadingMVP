...
SOURCE_RECORDS = {
    ...
    "the-leap-of-faith": {
        "title": "檀溪一跃",
        "source_title": "《三国演义》第034回 蔡夫人隔屏听密语 刘皇叔跃马过檀溪",
        "source_url": "https://zh.wikisource.org/wiki/三國演義/第034回",
        "related_urls": ["https://zh.wikisource.org/wiki/三國演義/第034回"],
        "license": PUBLIC_DOMAIN_NOTE,
        "summary": "刘备在荆州赴会后察觉不安，骑的卢来到檀溪边，鼓起勇气越过溪水，平安离开。",
        "excerpts": [
            "第034回回目写有：刘皇叔跃马过檀溪。",
            "原桥段核心是刘备在紧急时刻借的卢一跃脱险。",
        ],
        "rewrite_focus": "写成冒险脱困和信任坐骑的故事，不写宴会阴谋、追杀或伤害细节。",
    },
    "zhaoyun-changban": {
        "title": "赵云长坂坡救主",
    ...
    "single-blade-meeting": {
        "title": "单刀赴会",
        "source_title": "《三国演义》第066回 关云长单刀赴会 伏皇后为国捐生",
        "source_url": "https://zh.wikisource.org/wiki/三國演義/第066回",
        "related_urls": ["https://zh.wikisource.org/wiki/三國演義/第066回"],
        "license": PUBLIC_DOMAIN_NOTE,
        "summary": "鲁肃邀请关羽到江边会面商量荆州之事，关羽守信赴约，并用冷静谈话稳住局面。",
        "excerpts": [
            "第066回回目写有：关云长单刀赴会。",
            "关羽认为既已许诺，便不可失信，决定按约前往会面。",
        ],
        "rewrite_focus": "将单刀赴会写成守信、勇气与冷静外交，不写武器威胁、惊险挟持或流血。",
    },
    "calming-five-routes": {
        "title": "安居平五路",
        "source_title": "《三国演义》第085回 刘先主遗诏托孤儿 诸葛亮安居平五路",
        "source_url": "https://zh.wikisource.org/wiki/三國演義/第085回",
        "related_urls": ["https://zh.wikisource.org/wiki/三國演義/第085回"],
        "license": PUBLIC_DOMAIN_NOTE,
        "summary": "刘禅听说五路消息而忧心，诸葛亮从容说明已分别用沟通、安排和使者化解难题。",
        "excerpts": [
            "第085回回目写有：诸葛亮安居平五路。",
            "孔明说五路兵至，自己并非观鱼，而是在思考对策。",
        ],
        "rewrite_focus": "突出镇定思考、分步解决和和平沟通，不写军事压迫或成人政治细节。",
    },
    "seven-captures": {
        "title": "七擒孟获",
    ...
    "careful-letter-chushi": {
        "title": "出师表里的叮嘱",
        "source_title": "《三国演义》第091回 祭泸水汉相班师 伐中原武侯上表",
        "source_url": "https://zh.wikisource.org/wiki/三國演義/第091回",
        "related_urls": ["https://zh.wikisource.org/wiki/三國演義/第091回"],
        "license": PUBLIC_DOMAIN_NOTE,
        "summary": "诸葛亮回到成都后，向刘禅呈上《出师表》，把亲近贤良、听取建议、办事公平等叮嘱写清楚。",
        "excerpts": [
            "第091回回目写有：伐中原武侯上表。",
            "原桥段核心是诸葛亮向后主呈上《出师表》，留下恳切叮嘱。",
        ],
        "rewrite_focus": "只取上表和叮嘱段落，写责任、倾听和公平；不写泸水祭祀、鬼神、死亡或军事出征细节。",
    },
    "street-pavilion-lesson": {
        "title": "街亭听劝课",
        ...
        "license": PUBLIC_DOMAIN_NOTE,
        "summary": "马谡守街亭时没有认真听王平的提醒，安排不够稳妥，使大家学到听取建议的重要。",
        "excerpts": [
            "第095回回目写有：马谡拒谏失街亭。",
            "王平多次提醒驻扎位置不妥，马谡没有采纳。",
        ],
        "rewrite_focus": "只写听劝、复盘和承担责任的教训，不写战斗过程、惩罚或后续处置。",
    },
    "empty-fort": {
        "title": "空城计",
        "source_title": "《三国演义》第095回 马谡拒谏失街亭 武侯弹琴退仲达",
