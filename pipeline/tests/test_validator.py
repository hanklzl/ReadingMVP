...
class PolyphoneLintTest(unittest.TestCase):
    ...
    def test_flags_guarded_current_story_polyphones(self):
        ...
        self.assertFlags("谁称得上英雄", {2: "dé"}, "称得上")
        self.assertFlags("郑重交还", {3: "hái"}, "交还")
        self.assertFlags("重新核对时间", {0: "zhòng"}, "重新")
        self.assertFlags("照顾同行的人", {2: "háng"}, "同行")
        self.assertFlags("准备行动", {2: "háng"}, "行动")
        self.assertFlags("山路又长又弯", {3: "zhǎng"}, "又长又弯")
        self.assertFlags("木头载具", {2: "zǎi"}, "载具")
        self.assertFlags("能转动的木轮", {1: "zhuǎn"}, "转动的木轮")
        self.assertFlags("小旗转了方向", {2: "zhuàn"}, "转了方向")
        self.assertFlags("不好转弯", {2: "zhuàn"}, "转弯")
        self.assertFlags("小旗转向", {2: "zhuàn"}, "转向")
        self.assertFlags("锅里冒着热气", {3: "zháo"}, "冒着")
        self.assertFlags("他笑着问", {2: "zháo"}, "笑着")
    ...
    def test_does_not_flag_guarded_current_story_polyphones_when_correct(self):
        ...
        self.assertClean("谁称得上英雄", {2: "de"})
        self.assertClean("郑重交还", {3: "huán"})
        self.assertClean("重新核对时间", {0: "chóng"})
        self.assertClean("照顾同行的人", {2: "tóng", 3: "xíng"})
        self.assertClean("准备行动", {2: "xíng"})
        self.assertClean("山路又长又弯", {3: "cháng"})
        self.assertClean("木头载具", {2: "zài"})
        self.assertClean("能转动的木轮", {1: "zhuàn"})
        self.assertClean("小旗转了方向", {2: "zhuǎn"})
        self.assertClean("不好转弯", {2: "zhuǎn"})
        self.assertClean("小旗转向", {2: "zhuǎn"})
        self.assertClean("锅里冒着热气", {3: "zhe"})
        self.assertClean("他笑着问", {2: "zhe"})
